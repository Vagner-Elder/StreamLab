      ...
      <header>
        <div class="container ">
          ...
          {{-- BARRA DE NAVEGACION --}}
            <nav>
              <ul id="menuitem">
                <li><a href="{{ route('pelicula.indexadmin') }}">Inicio</a></li>
                <li><a href="product.html">Movies</a></li>
                <li><a href="index.html">Tv Shows</a></li>
                <li><a href="{{ route('pelicula.create') }}">Añadir</a></li>
              </ul>
            </nav>
          ...
          <div class="item">
            <div class="box" > {{-- contiene la informacion parte debajo de la imagen --}}
              <div class="imgBox">
                ...
                <div class="icon">
                    {{-- <a href="{{ route("pelicula.destroyadmin", $pelicula->ID) }}" style="color:white;" class="delete-link" data-id="{{ $pelicula->ID }}"> --}}
                        <a href="#" style="color:white;" class="delete-link" data-id="{{ $pelicula->ID }}">
                        <i class="fa fa-trash"></i> {{-- icono mas --}}
                    </a>           
                </div> 
              </div>
